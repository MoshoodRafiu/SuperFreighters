...
<p>Your order will be picked up on {{ $data['order']['pickUpDate'] }} delivered to {{ $data['order']['deliveryAddress'] }} on {{ $data['order']['deliveryDate'] }} by {{ $data['order']['modeOfDelivery'] }}.</p>
